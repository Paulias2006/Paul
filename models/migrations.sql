-- Migration: Combined migration file (separated by database)
-- Note: This file contains tables for both databases. Use the separated files for clarity:
-- - migrations_alitogoshop.sql for alitogoshop database
-- - migrations_alitogo.sql for alitogo database

-- ===========================================
-- TABLES FOR ALITOGO DATABASE (PAYMENT SYSTEM)
-- ===========================================
CREATE TABLE IF NOT EXISTS ap_transactions (
  ...
  product_amount DECIMAL(12,2) DEFAULT 0 COMMENT 'Montant du produit',
  transport_amount DECIMAL(12,2) DEFAULT 0 COMMENT 'Montant du transport',
  ...
  platform_share DECIMAL(12,2) DEFAULT 0 COMMENT 'Part de la plateforme',
  seller_share DECIMAL(12,2) DEFAULT 0 COMMENT 'Part du vendeur',
  courier_share DECIMAL(12,2) DEFAULT 0 COMMENT 'Part du coursier',
