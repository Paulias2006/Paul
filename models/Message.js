...
const messageSchema = new mongoose.Schema(
  {
    ...
    metadata: {
      ...
      deliveryStatus: {
        type: String,
        enum: ['assigned', 'picked_up', 'in_transit', 'delivered', 'delivered_to_pickup', 'cancelled'],
        default: null
      },
      ...
      pickup_point_network: String,
      pickup_point_account_name: String,
      pickup_point_share: Number,
      pickupPointStatus: String,
      pickupPointUserId: String,
      pickupPointDropoffAt: Date,
      pickupPointConfirmedAt: Date,
      pickupPointHandedOverAt: Date,
      pickupPointHandoverUserId: String,
      deliveredAt: Date,
