...
const buildMessageMetadata = ({
  ...
  paymentReference: toStringSafe(paymentReference),
  ...
  try {
    ...
    const deliveryDoc = {
      ...
      payment: {
        ...
        payment_reference: toStringSafe(payment_reference || legacy_payment_reference),
      },
      delivery_info: {
    ...
    const baseMeta = buildMessageMetadata({
      ...
      paymentReference: payment_reference || legacy_payment_reference,
      items,
      legType: leg_type,
